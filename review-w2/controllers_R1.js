...
.controller('DishDetailController', ['$scope', '$stateParams', 'menuFactory', 'baseURL', '$ionicPopover', 'favoriteFactory', '$ionicListDelegate','$ionicModal' , '$timeout', function ($scope, $stateParams, menuFactory, baseURL, $ionicPopover, favoriteFactory, $ionicListDelegate, $ionicModal, $timeout) {
    $scope.baseURL = baseURL;
    $scope.dish = {};
