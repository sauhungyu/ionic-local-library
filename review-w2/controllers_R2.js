angular.module('conFusion.controllers', [])
  ...
  .controller('DishDetailController', function($scope, $stateParams, menuFactory, favoriteFactory, baseURL, $ionicPopover, $ionicModal) {
    ...
    $scope.addComment = function() {
      console.log('addComment', $scope.comment);
