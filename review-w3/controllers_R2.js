...
.controller('MenuController', ['$scope', '$ionicListDelegate', 'favoriteFactory', 'baseURL', 'dishes',
    function ($scope, $ionicListDelegate, favoriteFactory, baseURL, dishes) {
...
.controller('DishDetailController', ['$scope', '$stateParams', 'menuFactory', 'favoriteFactory',
    'baseURL', 'dish', '$ionicPopover', '$ionicModal',

    function ($scope, $stateParams, menuFactory, favoriteFactory,
        baseURL, dish, $ionicPopover, $ionicModal) {
...
.controller('FavoritesController', ['$scope', 'menuFactory', 'favoriteFactory', 'baseURL', 'dishes', 'favorites',
    '$ionicListDelegate', '$ionicPopup', '$ionicLoading', '$timeout',

    function ($scope, menuFactory, favoriteFactory, baseURL, dishes, favorites,
        $ionicListDelegate, $ionicPopup, $ionicLoading, $timeout) {
