...
.controller('DishDetailController', ['$scope', '$stateParams', 'dish', 'menuFactory', 'baseURL', '$ionicPopover', 'favoriteFactory', '$ionicListDelegate','$ionicModal' , '$timeout', function ($scope, $stateParams, dish, menuFactory, baseURL, $ionicPopover, favoriteFactory, $ionicListDelegate, $ionicModal, $timeout) {
    $scope.baseURL = baseURL;
    $scope.dish = {};
