...
angular.module('conFusion',['ionic', 'LocalStorageModule', 'ngCordova', 'conFusion.controllers', 'conFusion.services'])
...
.config(function($stateProvider, $urlRouterProvider, localStorageServiceProvider) {
  ...
  .state('app.aboutus', {
	...
	resolve: {
              leader:  ['corporateFactory', function(corporateFactory){
                ...
                return corporateFactory.get({id:1});
			          }],
  ...
  .state('app.dishdetails', {
    ...
    views: {
      'mainContent': {
		...
		// resolve means equivalence replacement
	resolve: {
 ...
 localStorageServiceProvider.setPrefix('conFusion');
