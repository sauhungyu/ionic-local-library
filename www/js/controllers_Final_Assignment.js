...
.controller('AppCtrl', function ($scope, $ionicModal, $timeout, $localStorage, $ionicPlatform, $cordovaCamera, $cordovaImagePicker) {
    ...
    $scope.loginData = $localStorage.getObject('userinfo', '{}');   // get userinfo key else then return empty object
...
.controller('DishDetailController', ['$scope', '$stateParams', 'dish', 'menuFactory', 'baseURL', '$ionicPopover', 'favoriteFactory', '$ionicListDelegate','$ionicPlatform', '$cordovaLocalNotification', '$cordovaToast', '$ionicModal' , '$timeout', function ($scope, $stateParams, dish, menuFactory, baseURL, $ionicPopover, favoriteFactory, $ionicListDelegate, $ionicPlatform, $cordovaLocalNotification, $cordovaToast, $ionicModal, $timeout) {
    $scope.baseURL = baseURL;
    $scope.dish = {};
    ...
    $scope.addFavorite = function (index) {
                ...
                $ionicPlatform.ready(function () {                    
                  ...
                  $cordovaLocalNotification.schedule({
                            id: 1,
                            title: "Added Favorite to Confusion",
                            text: $scope.dishes[index].name
                        }).then(function () {
                            console.log('Added Favorite to Confusion'+$scope.dishes[index].name);
                        },
                function () {
                    console.log('Failed to add Notification ');
                });
...
.controller('FavoritesController', ['$scope', 'dishes', 'favorites', 'favoriteFactory', 'baseURL', '$ionicListDelegate', '$ionicPopup', '$ionicLoading', '$ionicPlatform', 'cordovaVibration', '$timeout', function ($scope, dishes, favorites, favoriteFactory, baseURL, $ionicListDelegate, $ionicPopup, $ionicLoading, $ionicPlatform, cordovaVibration, $timeout) {
        ...
        confirmPopup.then(function (res) {
            ...
            $ionicPlatform.ready(function () {   
                    ...
                    $cordovaVibration.vibrate(2000)   
                        .then(function () {
                            console.log('Deleted Favorite '+$scope.dishes[index].name);
                        },
                function () {
